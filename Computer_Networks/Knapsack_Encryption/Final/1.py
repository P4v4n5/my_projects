...
if __name__ == "__main__":
    ...
    print("Randomly generated Super Increasing Key/Private key is ---> ", super_increasing_knapsack)

    multiplexer_and_modulus = generate_multiplexer_and_modulus(super_increasing_knapsack)
    print("Multiplexer and Modulus respectively are ---> ", multiplexer_and_modulus)

    public_key = generate_public_key(super_increasing_knapsack, multiplexer_and_modulus[0], multiplexer_and_modulus[1])
    print("The calculated Public Key that would be shared is ---> ", public_key)
    ...
    print("The above Public key is shared to USER 2, so as to receive a Cipher text")
    print("Waiting for a Cipher text from USER 2")
    ...
    print("The final Plaintext/Meassage that is shared by USER 2 to USER 1 is --> ", final_list)
