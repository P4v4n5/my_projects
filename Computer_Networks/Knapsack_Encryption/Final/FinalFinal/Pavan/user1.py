...
class TCP_User1:
    ...
    # decrypt_matrix_generator, an inverse function is formulated to give a decrypting matrix
    ...
    # find_combination, match the decryption matrix with the super increasing list, to provide combinations of matching pattern
    ...
    def main(self, n):
        ...
        # final_plain_text = 0  # Initialize final_plain_text outside the loop
        final_list = []
        for each in decryption_matrix:
            ...
            # Log only the final plain text after the loop completes
