...
class TCP_User2:
    ...
    def main(self):
        ...
        plaint_text_input_binary_list = user2.input_to_list(binary_plain_text)
        length = len(plaint_text_input_binary_list)
        ...
        time.sleep(2)
        cipher_text = self.send_cipher_text(plaint_text_input_binary_list, public_key, tcp_socket, length)
