...
class TCP_User1:
    ...
    def main(self, n):
        ...
        time.sleep(10)
        cipher_text = self.receive_cipher_text(tcp_socket, conn)
        ...
        self.logger.info("The final Plaintext/Message that is shared by USER 2 to USER 1 is --> %s", final_list)
