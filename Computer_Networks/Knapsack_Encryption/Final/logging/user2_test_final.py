...
class TCP_User2:
    ...
    def main(self):
        ...
        binary_plain_text = self.decimal_to_binary()  # take decimal input and Convert decimal to binary
        ...
        time.sleep(2)
        cipher_text = self.send_cipher_text(plaint_text_input_list, public_key, tcp_socket, length)
    ...
    def decimal_to_binary(self):
        ...
        # print(decimal_input)
        binary_num = bin(decimal_input)[2:]
        return binary_num
